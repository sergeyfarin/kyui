...
class QSimpleFontWidget(QFrame):
...
#        comboBox.setSizePolicy(preferredSizePolicy)
        ...
        sizeLabel.setSizePolicy(fixedSizePolicy)
        
        spinBox = QSpinBox(self)
        spinBox.setObjectName("spinBox")
        spinBox.setSizePolicy(preferredSizePolicy)
        spinBox.setSuffix("")
...
class GenericDialog(QDialog):
    ...
    def __setupUi(self):
        ...
        self.widget = QSimpleFontWidget(self.font(), self)
